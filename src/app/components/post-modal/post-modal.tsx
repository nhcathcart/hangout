...
export default function PostModal() {
  ...
  const validCSSClasses =
    "block bg-neutral-50 w-full rounded border p-2 pr-10 text-neutral-900 border border-neutral-900 border-opacity-40 sm:text-sm sm:leading-6";
  //states
                ...
                <Dialog.Panel className="relative w-full max-w-[864px] h-full p-6 transform overflow-hidden rounded bg-neutral-50 px-4 pb-4 pt-5 text-left shadow-xl transition-all h-70vh">
                  <form className="[&>*]:mt-4" onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-around">
                      <button
                        className="flex rounded px-3 py-2 text-lg bg-neutral-200 hover:bg-neutral-300"
                        type="submit"
                      >
                        Submit Post
                      </button>
                      <button
                        className="flex justify-center rounded px-3 py-2 text-lg bg-red-800 bg-opacity-50 hover:bg-opacity-90 w-[119.45px]"
                        onClick={(e) => {
                          e.preventDefault();
                          setOpen(false);
                        }}
